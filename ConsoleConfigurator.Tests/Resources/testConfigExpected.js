...
const config = {
  ...
  searchResult: {
    max_attribute_count: env('MAX_ATTRIBUTE_COUNT').default(5000).exec(),
  },
  ...
  messageQueue: {
    host: env('AZURE_SERVICEBUS_HOST').default('TEST_HOST').exec(),
    ...
    serviceName: env('SERVICE_NAME').default('NEW_TEST_NAME').exec(),
  },
  service: {
